        ...
        <style>
            * { box-sizing: border-box; }
            body {
                ...
                margin: 0;
                padding: 16px;
                background: linear-gradient(135deg, #fdf2f2 0%, #eff6ff 100%);
                color: #333;
                line-height: 1.5;
            }
            ...
            .container {
                ...
                border-radius: 12px;
                overflow: hidden;
                box-shadow: 0 8px 28px rgba(29, 78, 216, 0.12), 0 3px 12px rgba(185, 28, 28, 0.08);
            }
            ...
            @media (max-width: 480px) {
                ...
                .news-item { gap: 6px; padding: 8px 0; }
                .new-item { gap: 8px; }
    ...
    html += """
            ...
            <div class="footer">
                <div class="footer-content">
                    由 <span class="project-name">大圣舆情AI</span> 生成 ·
        ...
        <script>
            async function saveAsImage() {
                ...
                try {
                    ...
                    const now = new Date();
                    const filename = `大圣舆情AI_热点新闻分析_${now.getFullYear()}${String(now.getMonth() + 1).padStart(2, '0')}${String(now.getDate()).padStart(2, '0')}_${String(now.getHours()).padStart(2, '0')}${String(now.getMinutes()).padStart(2, '0')}.png`;
            ...
            async function saveAsMultipleImages() {
                ...
                try {
                    ...
                    // 下载所有图片
                    const now = new Date();
                    const baseFilename = `大圣舆情AI_热点新闻分析_${now.getFullYear()}${String(now.getMonth() + 1).padStart(2, '0')}${String(now.getDate()).padStart(2, '0')}_${String(now.getHours()).padStart(2, '0')}${String(now.getMinutes()).padStart(2, '0')}`;
